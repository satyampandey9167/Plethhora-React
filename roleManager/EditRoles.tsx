...
export const EditRoles = () => {
    ...
    const handleSubmit = async (event: any) => {
        ...
        alert(responseData + "Successfully Satyam !")
                ...
                <form >
                    ...
                    <div className="search-section container">
                        ...
                        <label className="role-search-label">
                            Rolename
                            <input type="text" name="roleName" value={roles.roleName} className="role-search-input" />
                        </label>
                        <label className="role-search-label">
                            Status

                            <input type="text" name="roleName" value={roles.isActive} className="role-search-input" />
                        ...
                        <label className="role-search-label">
                            Customer Name
                            <input type="text" name="roleName" value={roles.customerId} className="role-search-input" />
